    ...
    <div className="flex flex-col items-center px-4 sm:px-8 lg:px-16 bg-[#252B42] overflow-hidden">
      ...
      <nav className="p-4 w-full">
        <div className="container mx-auto flex justify-between items-center">
          ...
          {/* Nav Links */}
          <div className="hidden md:flex space-x-8 text-white text-[17px] leading-[24px]">
            <span>Home</span>
            <span>Product</span>
            <span>Pricing</span>
            <span>Contact</span>
          ...
          <div className="flex space-x-4">
            <span className="text-[#ffffff] text-[17px] hover:text-[#cccccc]">Login</span>
      ...
      <div className="flex flex-col items-center gap-10 mt-8 sm:mt-16">
        ...
        <div className="flex flex-wrap justify-center mt-10 gap-6 mb-20">
          ...
          <div className="bg-white text-black p-6 rounded-lg shadow-md w-full sm:w-[328px]">
            <div className="w-20 h-20 rounded-xl bg-[#FCEBEB] mx-auto mb-4 ml-4"></div>
          ...
          {/* Second Card */}
          <div className="bg-white text-black p-6 rounded-lg shadow-md w-full sm:w-[328px]">
            <div className="w-20 h-20 rounded-xl bg-[#B9EAA8] mx-auto mb-4 ml-4"></div>
          ...
          <div className="bg-[#35A6F0] text-white p-6 rounded-lg shadow-md w-full sm:w-[328px]">
            <div className="w-20 h-20 rounded-xl bg-white mx-auto mb-4 ml-4"></div>
